...
<nav className="bg-white text-my-black dark:bg-gray-900 w-full z-50 rounded-t-3xl border-b  dark:border-gray-600">
  ...
  <div className={`items-center ${showNav? '': 'hidden'} w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
    <ul className="flex flex-col gap-2 p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
